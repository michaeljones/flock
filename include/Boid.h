...
GraphicsLib::Vector Acc;

/*! 3-dimensional vector in which each component is the boid's rotation around a particular access. For example, Dir.x is the pitch of the boid in radians, ie. the rotation around the x axis */
...
/*! \brief this method draws the boid at location Pos and with orientation defined by the current velocity
	\param floorHeight - the floor height of the world which is used for drawing simple shadows on the ground */
