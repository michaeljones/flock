...
GraphicsLib::Point3 flockCentre;

/*! Default Null vector for reseting other vector easily */
GraphicsLib::Vector Null;
...
void Clamp(GraphicsLib::Vector &value, float maxValue);
...
void GoalFlockCentring(GraphicsLib::Point3 &target);
...
void Update(GraphicsLib::Point3 &target);
